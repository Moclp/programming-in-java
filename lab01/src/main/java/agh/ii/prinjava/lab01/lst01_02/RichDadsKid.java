 ...
 *         refers to compatibility of interfaces and establishes an <i>IS-A</i> relationship</li>
 *  </ul>
 * <p>
 *  Note: Java (but also C++ and C#) consolidates both ideas, i.e., an <i>IS-A</i> relationship is established
 *        via class extension and/or interface implementation
 */
public class RichDadsKid extends RichDad {
    ...
    public void newSkill1() {
        ...
        String skillName = "Java coding skill";
        int skillLevel = 8; // Java coding skill level

        System.out.println(getName() + " has developed the '" + skillName + "' to level " + skillLevel);
    }

    public void newSkill2() {
        String skillName = "Wireshark usage skill";
        int skillLevel = 7; // Wireshark usage skill level
